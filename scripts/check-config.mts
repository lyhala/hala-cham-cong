...
check("Thứ 7 chỉ làm sáng: buổi chiều đặt 12:00 – 12:00 (giờ vào = giờ ra) → không làm buổi chiều", parseWorkSchedule(form({ ...ws, ...weekdays([1, 2, 3, 4, 5, 6]), ms_6: "08:30", me_6: "12:00", as_6: "12:00", ae_6: "12:00" })).value?.daySchedules, { "6": { morningStart: "08:30", morningEnd: "12:00", afternoonStart: null, afternoonEnd: null, unit: null } });
check("Chủ nhật chỉ làm chiều: buổi sáng 12:00 – 12:00", parseWorkSchedule(form({ ...ws, ...weekdays([1, 2, 3, 4, 5, 0]), ms_0: "12:00", me_0: "12:00", as_0: "13:30", ae_0: "17:30" })).value?.daySchedules["0"]?.morningStart, null);
check("Cả 2 buổi đều 12:00 – 12:00 (không có buổi nào) bị chặn", has(parseWorkSchedule(form({ ...ws, ...weekdays([1, 2, 3, 4, 5, 6]), ms_6: "12:00", me_6: "12:00", as_6: "12:00", ae_6: "12:00" })), "ít nhất 1 buổi"), true);
