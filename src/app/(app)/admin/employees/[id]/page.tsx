...
import { LeaveYearCard } from "../_components/LeaveYearCard";
...
export default async function EmployeeDetailPage(props: PageProps<"/admin/employees/[id]">) {
  ...
  return (
    <div style={{ maxWidth: 720 }}>
      ...
      {/* Đầu năm (T1–T3) hiện thêm thẻ phép của năm vừa chốt: phiếu lương tháng 12 được tính vào đầu năm sau nên vẫn điều chỉnh được */}
      {Number(today.slice(5, 7)) <= 3 && <LeaveYearCard employeeId={e.id} year={year - 1} closed />}
      <LeaveYearCard employeeId={e.id} year={year} />
